...
const { addItems } = require('./frontend');
// const items = [
...
const items = [
    { name: 'Mask Francois 1er', lot_number: '98712345', ean_code: '221B', expiration_date: '2030-01-01' },
];

addItems('cert1', 'edskS6DTBx1QXuZ23eR93MgymHrAp9yn2Vaxp8jXtK7W6hqtarRSMRHFX32Qw2KzDcMtLaqQkXuHgsEEfgChumsnZuaboLqd1q', items);
